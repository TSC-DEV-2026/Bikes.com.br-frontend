...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const pessoa = userData?.pessoa as Record<string, unknown> | undefined;
  ...
  const saveEndereco = async (enderecoData: Endereco) => {
    try {
      ...
      const msg =
        error instanceof Error ? error.message : "Ocorreu um erro ao tentar salvar a localização";
